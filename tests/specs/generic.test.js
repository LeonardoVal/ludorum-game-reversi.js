...
define(['creatartis-base', 'sermat', 'ludorum', 'ludorum-game-reversi'],
function (base, Sermat, ludorum, ludorum_game_reversi) {
	...
	describe("games.Othello", function () {
		var game = new ludorum_game_reversi.Othello(),
